...
const initialState = {
    posts: [], // Ensure posts are initialized as an array
    loading: false,
    error: null,
};
...
const postsReducer = (state, action) => {
    switch (action.type) {
        ...
        // If state.posts is not an array, fallback to an empty array
        case "SET_POSTS":
            return { ...state, posts: Array.isArray(action.payload) ? action.payload : [] };
        // Ensure payload is an array, otherwise fallback to an empty array
        case "SET_LOADING":
